...
public class UserCtrl {
	...
	public String login(@RequestParam(value="user_username", required=false) String user_username, @RequestParam(value="user_password", required=false) String user_password, Model model, HttpSession httpSession){
		String error = null;
